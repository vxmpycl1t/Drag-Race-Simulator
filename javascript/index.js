...
var ninab = new Queen("Nina Bo'Nina Brown", 4, 8, 8, 8, 8, 9, 12, "img/US9/NinaBo'ninaBrownS9Cast.jpg");
...
var asia = new Queen("Asia O'Hara", 9, 5, 6, 4, 7, 7, 8, "img/US10/AsiaO'HaraS10Cast.jpg");
...
var sumting = new Queen("Sum‏‏‎ Tin Wong", 9, 9, 7, 8, 9, 8, 8, "img/UK1/SumTingWongDRUK1Cast.jpg");
...
var mama = new Queen("Ma'Ma Queen", 7, 7, 5, 6, 8, 10, 7, "img/HOLL1/Ma'MaQueenDRH1Cast.jpg");
...
function CheckForReturning() {
    ...
    if (currentCast.length == 5 && all_stars){
        if (returningQueen == false) {
            returningQueen = true;
            return true;
        }else{
    ...
    for (var i = 0; i < smack.length; i++) {
        ...
        if (smack1.length == 1 && smack.length == 0) {
           ...
           //  smack1.splice(smack1.indexOf(queen3), 1);
            ...
            lipSync_1.sort(function (a, b) { return (b.lipsyncScore - a.lipsyncScore); });
            screen.createBold(lipSync_1[0].getName() + ", shantay you stay! (" + lipSync_1[0].lipsyncScore + ")");
            screen.createBold(lipSync_1[1].getName() + " (" + lipSync_1[1].lipsyncScore + ") and " + lipSync_1[2].getName() + " (" + lipSync_1[2].lipsyncScore +"), you're getting the porkchop...");
            if (queen1 == lipSync[0]) {
